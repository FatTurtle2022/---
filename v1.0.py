...
path = tk.StringVar()
path_text = tk.Label(window, textvariable=path, bg='white', font=('Arial,12'), width=51, height=2)
path_text.place(x=0,y=40)
path.set('请选择文件')
...
cut_Button = tk.Button(window, text="剪辑，启动！", width=34, height=2, command=cut)
